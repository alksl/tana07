...
for i=1:size(dirs, 1),
    ...
    if exist(strcat(str, '\data\', cur.name, '\A.mat')), n_datasets=n_datasets+1; datasets{n_datasets+1, 1}=strcat(str, '\data\', cur.name); end
end
...
if get(handles.StoreRes, 'Value')==1, 
    ...
    if get(handles.SVDRadio, 'Value')==1, 
        str=strcat(dataset, '\svd');
        if ~exist(str), mkdir(str); end
        str=strcat(str, '\k_', num2str(k));
        if ~exist(str), 
            mkdir(str); 
        else, 
            str1=strcat(str, '\Usvd.mat'); str2=strcat(str, '\Ssvd.mat'); str3=strcat(str, '\Vsvd.mat'); 
            if exist(str1), delete(str1); end; if exist(str2), delete(str2); end; if exist(str3), delete(str3); end; 
        end
        str1=strcat(str, '\Usvd'); str2=strcat(str, '\Ssvd'); str3=strcat(str, '\Vsvd');
        save(str1, 'Usvd'); save(str2, 'Ssvd'); save(str3, 'Vsvd'); 
    end
    if get(handles.PCARadio, 'Value')==1, 
        str=strcat(dataset, '\pca');
        if ~exist(str), mkdir(str); end
        str=strcat(str, '\k_', num2str(k));
        if ~exist(str), 
            mkdir(str); 
        else, 
            str1=strcat(str, '\Upca.mat'); str2=strcat(str, '\Spca.mat'); str3=strcat(str, '\Vpca.mat'); 
            if exist(str1), delete(str1); end; if exist(str2), delete(str2); end; if exist(str3), delete(str3); end; 
        end
        str1=strcat(str, '\Upca'); str2=strcat(str, '\Spca'); str3=strcat(str, '\Vpca');
        save(str1, 'Upca'); save(str2, 'Spca'); save(str3, 'Vpca');         
    end
    if get(handles.CLSIRadio, 'Value')==1, 
        str=strcat(dataset, '\clsi');
        if ~exist(str), mkdir(str); end
        str=strcat(str, '\k_', num2str(k));
        if ~exist(str), 
            mkdir(str); 
        else, 
            str1=strcat(str, '\Xclsi.mat'); str2=strcat(str, '\Yclsi.mat');
            if exist(str1), delete(str1); end; if exist(str2), delete(str2); end;
        end
        str1=strcat(str, '\Xclsi'); str2=strcat(str, '\Yclsi');
        save(str1, 'Xclsi'); save(str2, 'Yclsi');
    end
    if get(handles.CMRadio, 'Value')==1, 
        str=strcat(dataset, '\cm');
        if ~exist(str), mkdir(str); end
        str=strcat(str, '\k_', num2str(k));
        if ~exist(str), 
            mkdir(str); 
        else, 
            str1=strcat(str, '\Xcm.mat'); str2=strcat(str, '\Ycm.mat');
            if exist(str1), delete(str1); end; if exist(str2), delete(str2); end;
        end
        str1=strcat(str, '\Xcm'); str2=strcat(str, '\Ycm');
        save(str1, 'Xcm'); save(str2, 'Ycm');        
    end
    if get(handles.SDDRadio, 'Value')==1, 
        str=strcat(dataset, '\sdd');
        if ~exist(str), mkdir(str); end
        str=strcat(str, '\k_', num2str(k));
        if ~exist(str), 
            mkdir(str); 
        else, 
            str1=strcat(str, '\Dsdd.mat'); str2=strcat(str, '\Xsdd.mat'); str3=strcat(str, '\Ysdd.mat'); 
            if exist(str1), delete(str1); end; if exist(str2), delete(str2); end; if exist(str3), delete(str3); end; 
        end
        str1=strcat(str, '\Dsdd'); str2=strcat(str, '\Xsdd'); str3=strcat(str, '\Ysdd');
        save(str1, 'Dsdd'); save(str2, 'Xsdd'); save(str3, 'Ysdd');         
    end
    if get(handles.SPQRRadio, 'Value')==1, 
        str=strcat(dataset, '\spqr');
        if ~exist(str), mkdir(str); end
        str=strcat(str, '\k_', num2str(k));
        if ~exist(str), 
            mkdir(str); 
        else, 
            str1=strcat(str, '\Qspqr.mat'); str2=strcat(str, '\Rspqr.mat'); str3=strcat(str, '\Apspqr.mat');
            if exist(str1), delete(str1); end; if exist(str2), delete(str2); end; if exist(str3), delete(str3); end;
        end
        str1=strcat(str, '\Qspqr'); str2=strcat(str, '\Rspqr'); str3=strcat(str, '\Apspqr'); 
