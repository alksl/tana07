...
if exist(strcat(current_path, '/documentation/tmg.htm')),
    open(strcat(current_path, '/documentation/tmg.htm'));
else,
...
stat=web('http://scgroup.hpclab.ceid.upatras.gr/scgroup/Projects/TMG/index.html', '-browser');
if stat~=0, web('http://scgroup.hpclab.ceid.upatras.gr/scgroup/Projects/TMG/index.html'); end
