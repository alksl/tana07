...
if tmp==1, 
    ...
    if mysql.is_set==1, 
        ...
        fid=fopen(strcat(matlabroot, '\toolbox\local\classpath.txt'), 'a'); fprintf(fid, '\n%s', str); fclose(fid);
...
str=strcat(fileparts(mfilename('fullpath')), '\classification'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\clustering'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\data'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\documentation'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\dr'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\results'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\retrieval'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\sample_documents'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\var'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\var\PROPACK'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\var\SPQR'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
str=strcat(fileparts(mfilename('fullpath')), '\var\SDDPACK\matlab'); addpath(str); 
an=sprintf('Adding directory %s...', str); disp(an);
savepath;
